...
class journalsecuritiesControllerDaily extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $id_pt = $user->id_pt;
           ...
           return view('report.securities.journal_daily.master', compact('master', 'bulan', 'tahun', 'tanggal', 'isSuperAdmin', 'user'));
    }
    ...
    $sheet->setCellValue('A6', 'Journal Effective Report - Report Details');
    ...
    foreach (range('A', 'G') as $columnID) {
        ...
        $filename = "ReportJournalEffective_{$bulan}_{$tahun}.xlsx";
    ...
    public function exportReportExcel(Request $request)
    {
        ...
        // Set judul tabel laporan
        $sheet->setCellValue('A6', 'Journal Report - Effective');
        $sheet->mergeCells('A6:G6'); // Menggabungkan sel untuk judul tabel
        $sheet->getStyle('A6')->getFont()->setBold(true)->setSize(14);
        $sheet->getStyle('A6')->getAlignment()->setHorizontal(Alignment::HORIZONTAL_CENTER);
        $sheet->getStyle('A6')->getFill()->setFillType(Fill::FILL_SOLID);
    ...
    public function exportPdf(Request $request, $id_pt)
{
    ...
    // Siapkan nama file
    $filename = "ReportJournalEffective_{$bulan}_{$tahun}.pdf";
...
public function exportCsv(Request $request, $id_pt)
{
    ...
    // Siapkan nama file
    $filename = "ReportJournalEffective_{$bulan}_{$tahun}.csv";
