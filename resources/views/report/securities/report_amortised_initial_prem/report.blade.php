        ...
        <div class="container mt-5" style="padding-right: 50px;">
            <section class="section">
                <div class="section-header">
                    <h4>REPORT AMORTISED INITIAL AT PREMIUM - TREASURY</h4>
                </div>
                @if(session('pesan'))
                        ...
                        <tbody>
                            @foreach ($loans as $loan)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('report-amortised-initial-prem.view', ['no_acc' => $loan->no_acc, 'id_pt' => $loan->id_pt])  }}" class="btn btn-sm btn-info">
