        ...
        <div class="container mt-5" style="padding-right: 50px;">
            <section class="section">
                <div class="section-header">
                    <h4>REPORT AMORTISED INITIAL BROKERAGE FEE - TREASURY</h4>
                </div>
                @if(session('pesan'))
                        ...
                        <tbody>
                            @foreach ($loans as $loan)
                                <tr>
                                    ...
                                    <td class="text-right">{{$loan->issuer_name}}</td>
                                    ...
                                    <td>{{ number_format($loan->eircalc*100,13)}}%</td>

                                        <td>
                                            {{-- <a href="{{route('under')}}" class="btn btn-sm btn-info">
                                                <i class="fas fa-eye" style="margin-right: 5px;"></i> View
                                            </a> --}}
                                            <a href="{{ route('report-amortised-cost.view', ['no_acc' => $loan->no_acc, 'id_pt' => $loan->id_pt]) }}" class="btn btn-sm btn-info">
                                                <i class="fas fa-eye" style="margin-right: 5px;"></i> View
                                            </a>
                                    </td>
                                </tr>
