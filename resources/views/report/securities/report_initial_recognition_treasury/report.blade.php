            ...
            <section class="section">
                ...
                <div class="table-responsive text-center">
                    <div class="d-flex align-items-center mb-2">
                        ...
                        <select class="form-select me-2" style="width: 120px;" id="monthSelect" onchange="changeMonth()">
                    ...
                    <table class="table table-striped table-bordered custom-table" style="width: 100%; margin: 0 auto;">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 20%; white-space: nowrap;">Debitur Name</th>
                                <th style="width: 15%; white-space: nowrap;">Balance</th>
                                <th style="width: 15%; white-space: nowrap;">Outstanding Up Front Fee</th>
                                <th style="width: 10%; white-space: nowrap;">Outstanding Transaction Cost</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach ($loans as $loan)
                                <tr>
                                    ...
                                    <td>{{ $loan->face_value }}</td>
                                    <td>{{ $loan->atdiscount }}</td>
