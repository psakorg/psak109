        ...
        <div class="container mt-5" style="padding-right: 50px;">
            <section class="section">
                <div class="section-header">
                    <h4>REPORT AMORTISED INITIAL FEE - SIMPLE INTEREST</h4>
                </div>
                @if(session('pesan'))
                    ...
                    <table class="table table-striped table-bordered custom-table" style="width: 100%; margin: 0 auto;">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 20%;">Up Front Fee</th>
                                <th style="width: 25%;">Outstanding Amount Initial Fee</th>
                        ...
                        <tbody>
                            @foreach ($loans as $loan)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('report-amorinitfee-si.view',  ['no_acc' => $loan->no_acc, 'id_pt' => $loan->id_pt]) }}" class="btn btn-sm btn-info">
