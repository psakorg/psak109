...
<div class="radio-inputs">
		<label>
			<input class="radio-input" type="radio" name="engine" value="effective" onchange="window.location.href='/admin/dashboard'">
...
<div class="row d-flex align-items-stretch mb-3">
    <div class="col-lg-3 col-6">
        <div class="small-box bg-info h-100">
            <div class="inner" style="overflow: hidden;">
                <h3 id="deb_name_display" style="font-size: 1.5em; white-space: normal; line-height: 1.2;">
                    {{ $master->issuer_name ?? 'N/A' }}
                </h3>
                <p>Issuer</p>
            </div>
            <div class="icon">
    ...
    <div class="col-lg-3 col-6">
        <div class="small-box bg-success h-100">
            <div class="inner">
                <h3 id="interest_rate_display">{{ number_format($master->coupon_rate * 100 ?? 0, 2) }} %</h3>
                <p>Coupon Rate</p>
            </div>
            <div class="icon">
                <i class="fas fa-chart-line"></i>
                ...
                <section class="col-lg-7 connectedSortable">
                    ...
                    <script>
                        ...
                        function fetchDebiturInfo(no_acc) {
                            ...
                            $.ajax({
                                url: '/dashboard/securities/debitur/' + no_acc, // Pastikan URL ini sesuai dengan route Anda
                                method: 'GET',
                ...
                <section class="col-lg-5 connectedSortable">
                    <div class="card bg-gradient-secondary">
                        <div class="card-header border-0">
                            <h3 class="card-title">Tabel Issuer</h3>
                            <div class="card-tools">
                                ...
                                <table class="table table-striped">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                            <th>Issuer</th>
                                            <th style="text-align: right;">Face Value (RP)</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @php
                                                ...
                                                <td>
                                                    <a href="javascript:void(0);"
                                                       ...
                                                       class="btn btn-link {{ $loan->no_acc === $defaultNoAcc ? 'active-button' : 'text-primary' }}">
                                                        <i class="fas fa-user"></i> {{ $loan->issuer_name }}
                                                    </a>
                                                </td>
                                                <td style="text-align: right;">
                                                    {{ number_format((float) str_replace(['$', ','], '', $loan->fair_value), 2, ',', '.') }}
                                                </td>
                                            </tr>

                                            @php
                                                $totalOutstanding += (float) str_replace(['$', ','], '', $loan->fair_value);
                                            @endphp
                                        @endforeach
