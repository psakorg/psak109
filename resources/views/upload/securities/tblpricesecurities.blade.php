...
<head>
  ...
  <title>Data Table Price Securities</title>
    ...
    <div class="content-wrapper">
        <div class="container ms-5 mt-5">
            <div class="section-header">
                <h1>Data Table Price Securities</h1>
            ...
            <div class="card">
                <div class="card-header">
                    <h6 class="m-0 font-weight-bold text-primary">tblpricesecurities</h6>
                </div>
       ...
       <!-- Pagination Links -->
        <div class="d-flex justify-content-between align-items-center mt-3">
            ...
            <div class="d-flex align-items-center">
                ...
                {{ $priceSecurities->links() }} <!-- Menampilkan pagination -->
