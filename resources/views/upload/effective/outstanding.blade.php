        ...
        <div class="container mt-5" style="padding-right: 50px; overflow: visible;">
            <section class="section" style="overflow: visible;">
                <div class="section-header">
                    <h4>DATA TABLE OUTSTANDING - EFFECTIVE</h4>
                </div>
...
<div class="modal fade" id="importModal" tabindex="-1" aria-labelledby="importModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('effective.outstanding.import') }}" method="POST" enctype="multipart/form-data">
                @csrf
...
<div class="modal fade" id="clearModal" tabindex="-1" aria-labelledby="clearModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('effective.outstanding.clear') }}" method="POST">
                @csrf
...
const reportUrl = "{{ route('effective.outstanding.index') }}";
